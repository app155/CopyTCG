...
public class CardManager : MonoBehaviour
{
    ...
    [SerializeField] List<Card> enemyCards;
    [SerializeField] Transform cardSpawnPoint;
    [SerializeField] Transform myCardLeft;
    [SerializeField] Transform myCardRight;
    [SerializeField] Transform enemyCardLeft;
    [SerializeField] Transform enemyCardRight;
    ...
    void SetOriginOrder(bool isMine)
    {
        ...
        {
            Card targetCard = isMine ? myCards[i] : enemyCards[i];
    ...
    {
        List<PRS> originCardPRSs = new();

        if (isMine)
            originCardPRSs = RoundAlignment(myCardLeft, myCardRight, myCards.Count, 0.5f, Vector3.one * 1.9f);

        else
            originCardPRSs = RoundAlignment(enemyCardLeft, enemyCardRight, enemyCards.Count, -0.5f, Vector3.one * 1.9f);

        List<Card> targetCards = isMine ? myCards : enemyCards;
